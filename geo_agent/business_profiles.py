...
PROFILES: dict[str, BusinessProfile] = {
    ...
    "legal": BusinessProfile(
        schema_type="LegalService",
        schema_id_suffix="legalservice",
        industry="legal",
        industry_label="Law Firm",
        customer_term="clients",
        provider_term="attorneys",
        service_category="practice areas",
        content_expert_label="legal marketing content strategist",
        service_keywords=[
            "practice area", "attorney", "lawyer", "legal",
            "personal injury", "family law", "criminal defense",
            "estate planning", "immigration", "bankruptcy",
            "business law", "real estate", "employment law",
            "civil litigation", "workers compensation",
            "consultation", "case evaluation",
        ],
        is_practice=False,
        use_dental_slugs=False,
        faq_seeds=[
    ...
    "medical": BusinessProfile(
        schema_type="MedicalBusiness",
        schema_id_suffix="medicalbusiness",
        schema_specialty="Medicine",
        industry="medical",
        industry_label="Medical Practice",
        customer_term="patients",
        provider_term="providers",
        service_category="medical services",
        content_expert_label="medical practice content strategist",
        service_keywords=[
            "service", "specialty", "condition", "treatment",
            "dermatology", "orthopedic", "cardiology", "pediatric",
            "internal medicine", "family medicine", "urgent care",
            "telehealth", "appointment", "insurance", "provider",
            "wellness", "preventive care", "physical therapy",
        ],
        is_practice=True,
        use_dental_slugs=False,
        faq_seeds=[
